...
_Sau khi triển khai thành công, Terraform sẽ hiển thị output chứa đường link của Load Balancer. Bạn chỉ cần click vào link `alb_dns_name` để truy cập vào ứng dụng web._
...
Các hình bên dưới minh họa các bước chính và kết quả trong quá trình triển khai:

1. Hình 1 — terraform apply

![terraform apply](image/1.png)

2. Hình 2 — terraform destroy

![terraform destroy](image/2.png)
